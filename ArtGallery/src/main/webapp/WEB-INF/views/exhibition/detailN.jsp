        ...
        <div class="row gx-5 mt-5" id="outer">
            ...
            <div class="col">
                ...
                <c:if test="${sessionScope.naverName ne null}">
	                <c:if test="${sessionScope.naverName eq exhibition.e_writer}">
		                <c:if test="${sessionScope.naverEmail eq exhibition.e_email}">
...
<script>
    $(document).ready(function () {
        ...
        $(".heart").on("click", function () {
			...
			$.ajax({
			    url :'/exhibition/heartN',
			    type :'POST',
			    data : {'e_number':${exhibition.e_number}, 'n_number':${sessionScope.naverNumber}},
